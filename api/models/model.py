...
class Site(Base):
    ...
    use_icon_as_answer_icon: Mapped[bool] = mapped_column(sa.Boolean, nullable=False, server_default=sa.text("false"))
    chatbot_icon_type = mapped_column(String(255), nullable=True)
    chatbot_icon = mapped_column(String(255), nullable=True)
    chatbot_icon_background = mapped_column(String(255), nullable=True)
